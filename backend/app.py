    ...
    try:
        ...
        if need_download:
            ...
            if content_length < 10000:
                print(f"  ⚠️ 文件太小，可能是 LFS 指针！检查 URL 是否正确")
            ...
            print(f"✅ 压缩文件已下载：{temp_file} ({os.path.getsize(temp_file)} bytes)")
            ...
            # 删除临时文件
            os.remove(temp_file)
            print(f"✅ 数据文件已解压到：{data_file} ({os.path.getsize(data_file)} bytes)")
